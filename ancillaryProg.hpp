...
public:
  ...
  ancillaryProg (QWidget *parent = 0, nvMapGL *ma = NULL, OPTIONS *op = NULL, MISC *mi = NULL, int32_t prog = 0, int32_t lock_point = 0);
  ~ancillaryProg ();
...
protected:
  ...
  uint8_t         command_line, command_line_up;
