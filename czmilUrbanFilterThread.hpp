...
#ifndef _CZMILURBANFILTERTHREAD_H_
#define _CZMILURBANFILTERTHREAD_H_


#include "pfmEdit3D.hpp"


class czmilUrbanFilterThread:public QThread
{
  Q_OBJECT 
...
public:
  ...
  czmilUrbanFilterThread (QObject *parent = 0);
  ~czmilUrbanFilterThread ();
...
protected:
  ...
  int32_t          l_rows, l_cols, l_width, l_height, l_row, l_col, *l_kill_count, l_pass;
